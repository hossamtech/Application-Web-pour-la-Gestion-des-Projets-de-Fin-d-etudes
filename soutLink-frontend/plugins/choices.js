    ...
    addComponents({
        '.choices': {
            ...
            '&[data-type*=select-one]': {
                ...
                '.choices__input': {
                    '@apply block w-full py-1 px-4 border-b border-slate-200 dark:border-zink-500 dark:bg-zink-700 bg-white m-0': {},
            ...
            '.choices__inner': {
                '@apply inline-block w-full py-1 px-4 text-sm align-top bg-white dark:bg-zink-700 border border-slate-200 dark:border-zink-500 rounded-md overflow-hidden': {},
                minHeight: '39px',
            }
        },
