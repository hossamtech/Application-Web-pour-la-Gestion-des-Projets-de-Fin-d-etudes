...
module.exports = plugin(function ({ addComponents, theme }) {
    addComponents({
        ...
        '.simplebar-track': {
            '@apply absolute ltr:right-0 rtl:left-0 bottom-0 overflow-hidden pointer-events-none !w-5': {},
            zIndex: 1,
        },
        ...
        '.simplebar-scrollbar': {
            '@apply absolute ltr:right-px rtl:left-px !w-2 before:absolute before:!bg-slate-500 before:rounded-md before:left-0 before:right-0 before:opacity-0': {},
