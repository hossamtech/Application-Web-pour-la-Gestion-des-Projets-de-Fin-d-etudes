...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      padding: {
        '6-important': '1.5rem !important',
        '0-important': '0 !important',
        '1-important': '0.25rem !important',
        '2-important': '0.5rem !important',
        '3.5-important': '0.875rem !important',
        'custom-3': '3px',
      },
      margin: {
        'custom-55': '55px', // Add a custom margin size
        '0-important': '0 !important',
      },
      height: {
        81: '81px', // Add a custom margin size
      },
      fontSize: {
        sm: '0.8125rem',//13px
        base: '0.875rem',//14px
      ...
      colors: {
        ...
        'vertical-menu-item': colors.slate[500],
        ...
        'vertical-menu-sub-item': colors.slate[500],
