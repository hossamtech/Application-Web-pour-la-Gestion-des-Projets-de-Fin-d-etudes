...
import { getUserDetails } from '../fn/authentication/get-user-details';
import { GetUserDetails$Params } from '../fn/authentication/get-user-details';
...
export class AuthenticationService extends BaseService {
  ...
  static readonly GetUserDetailsPath = '/auth/userDetails';
   ...
   */
  getUserDetails$Response(params?: GetUserDetails$Params, context?: HttpContext): Observable<StrictHttpResponse<UserDetailsResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  getUserDetails(params?: GetUserDetails$Params, context?: HttpContext): Observable<UserDetailsResponse> {
    return this.getUserDetails$Response(params, context).pipe(
      map((r: StrictHttpResponse<UserDetailsResponse>): UserDetailsResponse => r.body)
    );
  }
