...
import {cart, notification} from "../../../data/topbar";
import {MnDropdownComponent} from "../../../../components/dropdown";
import { DrawerModule } from '../../../../components/drawer/drawer.module';
import {UserDetailsResponse} from "../../../../../services/models/user-details-response";
import {getUserDetails} from "../../../../../services/fn/authentication/get-user-details";
...
export class TopbarComponent implements OnInit{
  ...
  size: any;
  cartlist: any;
  private userDetails: UserDetailsResponse = {};
  ...
  constructor(
    ...
    // Combine the latest values of the profileImg$ and fullName$ streams
    this.isDataLoaded$ = combineLatest([this.profileImg$, this.fullName$]).pipe(
        map(([profileImg, fullName]) => !!profileImg && !!fullName)
    );
  }
  ...
  ngOnInit(): void {
    this.getUserDetails();
    this.fetchCartAndNotifications();
  }
  ...
  //   }).subscribe({
  //     next: (user) => {
  //         this.profileImg = 'data:image/jpg;base64,' + user.profileImg;
