...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        label: 'Appointment',
        icon: 'calendar-days',
        link: '/encadrant/students-appointment',
        parentId: 2,
    },
